...
public class CategoryController implements Initializable {
    ...
    private void populateCategories() {
        ...
        TableView.TableViewSelectionModel<Category> selectionModel
                = categoriesTableView.getSelectionModel();
        ...
        selectedItems.addListener((ListChangeListener<Category>) change -> {
            if (!categories.isEmpty() && !selectedItems.isEmpty())
            {
                ...
                category.setState(categories.get(selectionModel.getSelectedIndex()
                ).getState());
